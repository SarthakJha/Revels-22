...
let delegateCardsURL = "\(baseURL)/api/user/delegatecard/getall"
let boughtDelegateCardsURL = "\(baseURL)/api/user/delegatecard/getmydelegatecards"
...
struct Networking {
    ...
    let registerEventURL = "\(baseURL)/api/user/event/register"
    let getRegisteredEventsURL = "\(baseURL)/api/user/event/getevents"
    let checkTokenURL = "\(baseURL)/api/user/getuser"
    let leaveTeamURL = "\(baseURL)/api/user/team/leave"
    let joinTeamURL = "\(baseURL)/api/user/team/join"
