...
//    }
    ...
    fileprivate func setupLayout() {
        ...
        collectionView.register(ProshowDay5Cell.self, forCellWithReuseIdentifier: cellId5)
    ...
    override func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        case 3:
            ...
            return cell
        case 4:
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: cellId5, for: indexPath) as! ProshowDay5Cell
            cell.proshowData = self.proshowData
            cell.rules = self.rules2
            return cell
        default:
...
class ProshowDay2Cell: UICollectionViewCell, UITableViewDelegate, UITableViewDataSource {
    ...
    fileprivate func setupTableView(){
        ...
        addSubview(tableView)
        tableView.anchor(top: topAnchor, left: leftAnchor, bottom: bottomAnchor, right: rightAnchor)
        tableView.register(ProTableViewCell.self, forCellReuseIdentifier: "cellIdSingle")
        tableView.backgroundColor = UIColor.CustomColors.Black.background
        tableView.separatorStyle = .none
        tableView.delegate = self
        tableView.dataSource = self
...
//                cell.locationLabel.text = "MiT FootBall Ground"
//                cell.artistImage1.image = UIImage(named: "Aakash Mehta")
//                cell.artistImage1.contentMode = .scaleAspectFit
//                cell.selectionStyle = .none
//                cell.descriptionLabel.text = "Description"
//                cell.ruleLabel.text = "Rules"
//            }
...
class ProshowDay3Cell: UICollectionViewCell, UITableViewDelegate, UITableViewDataSource {
    ...
    fileprivate func setupTableView(){
        ...
        tableView.register(ProTableViewCellSingle.self, forCellReuseIdentifier: "cellId")
        tableView.backgroundColor = UIColor.CustomColors.Black.background
        tableView.separatorStyle = .none
        tableView.delegate = self
        tableView.dataSource = self
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
           // guard let schedule = self.proshowData?["3"] else { return UITableViewCell()}
            let cell = tableView.dequeueReusableCell(withIdentifier: "cellId", for: indexPath ) as! ProTableViewCellSingle
           // let url1 = URL(string: schedule.artist_1_image_url ?? "")
...
class ProshowDay4Cell: UICollectionViewCell, UITableViewDelegate, UITableViewDataSource {
    ...
    fileprivate func setupTableView(){
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
           ...
           // let url1 = URL(string: schedule.artist_1_image_url ?? "")
            cell.artistImage1.image = UIImage(named: "KK")
            cell.artistImage1.contentMode = .scaleToFill
          //  let url2 = URL(string: schedule.artist_2_image_url ?? "")
...
//MARK: Proshow Day 5
class ProshowDay5Cell: UICollectionViewCell, UITableViewDelegate, UITableViewDataSource {
    ...
    fileprivate func setupTableView(){
        ...
        func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
           // guard let schedule = self.proshowData?["4"] else { return UITableViewCell()}
            let cell = tableView.dequeueReusableCell(withIdentifier: "cellId", for: indexPath ) as! ProTableViewCell
           // let url1 = URL(string: schedule.artist_1_image_url ?? "")
            cell.artistImage1.image = UIImage(named: "Nikhil ")
            cell.artistImage1.contentMode = .scaleToFill
          //  let url2 = URL(string: schedule.artist_2_image_url ?? "")
...
//MARK: Pro Table View Cell Single
...
//MARK: ProTableViewCellSingleHundia
